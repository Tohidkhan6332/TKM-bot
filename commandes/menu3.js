...
╚════--------------- \n\n`;
    ...
    var link = "https://telegra.ph/file/042cd0b6121a7923fd5d2.jpg";
    try {
        zk.sendMessage(dest, { image: { url: link }, caption: menuMsg, footer: "©TOHID INC" }, { quoted: ms });
    }
    catch (e) {
